...
print("sys path :",sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "../.."))))
...
local_file_path = "/home/prash/projects/mart_project/mart_project_files/file_from_s3/"
